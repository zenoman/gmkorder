...
$(function () {
    $('#list-data').DataTable({
        ...
        serverSide: true,
        order: [[0, "desc"]],
        ajax: '/backend/data-kategori-produk',
        columns: [
            {
            ...
            { 
                render: function (data, type, row) {
                    return '<img src="/img/kategoriproduk/thumbnail/' + row['gambar'] + '" class="img-thumbnail" width="100px;">'
                },
...
function hapusdata(kode) {
    ...
    swalWithBootstrapButtons.fire({
        ...
        if (result.value) {
            ...
            $.ajax({
                type: 'DELETE',
                url: '/backend/kategori-produk/' + kode,
                data: {
